  ...
  const features = [
    {
      ...
      description: "Generate personalized lesson content tailored to each student's learning style and pace."
    },
    {
      icon: <BookOpen size={40} className="text-indigo-600" />,
      title: "Interactive Content",
      description: "Engaging multimedia lessons with embedded quizzes and practice exercises."
    },
    {
    ...
    },
    {
      ...
      description: "Connect students and teachers in a supportive learning environment."
    }
  ];

  const testimonials = [
    {
      quote: "EduAgent AI has transformed how I teach. Creating personalized lessons takes minutes instead of hours!",
      author: "Dr. Sarah Johnson",
      role: "Mathematics Instructor"
    },
    {
      quote: "I've improved my grades in math by 30% since using EduAgent. The AI tutor explains concepts in a way I actually understand.",
      author: "Alex Martinez",
      role: "Grade 10 Student"
    },
    {
      quote: "The analytics dashboard helps me identify exactly where students are struggling so I can provide targeted support.",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
              Transform Education with <span className="text-indigo-600">AI-Powered</span> Learning
            </h1>
          ...
          >
            <div className="bg-white/80 backdrop-blur-xl border border-white/40 rounded-3xl shadow-xl p-8">
              ...
              <div className="bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl p-6 text-white">
                ...
                <p className="text-indigo-100 mb-4">Solving Quadratic Equations</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-xl text-gray-600">
              Whether you're a student or educator, EduAgent AI provides the tools you need to succeed
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Create or Select Content</h3>
              <p className="text-gray-600 mb-4">
                Instructors generate AI-powered lessons or choose from our library. Students access curated content.
              </p>
            ...
            >
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Engage and Learn</h3>
              <p className="text-gray-600 mb-4">
                Students interact with lessons, complete practice tasks, and get real-time AI assistance.
              </p>
              <div className="bg-gray-100 rounded-xl p-4 h-40 flex items-center justify-center">
                <div className="flex flex-col items-center">
            ...
            >
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Track and Improve</h3>
              <p className="text-gray-600 mb-4">
                Detailed analytics help students identify strengths and instructors optimize teaching strategies.
              </p>
              <div className="bg-gray-100 rounded-xl p-4 h-40 flex items-center justify-center">
                <div className="flex flex-col items-center">
            ...
            {testimonials.map((testimonial, index) => (
              ...
              >
                <div className="flex items-center mb-4">
                  {[...Array(5)].map((_, i) => (
                    <CheckCircle key={i} className="text-yellow-400 fill-current" size={20} />
                  ))}
                </div>
                <p className="text-gray-600 italic mb-6">"{testimonial.quote}"</p>
                <div className="flex items-center">
                  <div className="w-12 h-12 bg-indigo-100 rounded-full flex items-center justify-center mr-4">
                    <span className="text-indigo-600 font-bold">{testimonial.author.charAt(0)}</span>
                  </div>
                  <div>
